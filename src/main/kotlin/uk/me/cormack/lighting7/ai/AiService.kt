    ...
    private fun buildSystemPrompt(): String {
        ...
        for (master in state.show.fxEngine.speedMasters.masterStates()) {
            ...
            val follow = master.followNum?.let {
                ", follows Master 1 at $it/${master.followDen} — tempo derived, set_bpm refused"
            } ?: ""
            sb.appendLine(
